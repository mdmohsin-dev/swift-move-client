...
const Banner = () => {
    return (
        <div className="min-h-[85vh] w-11/12 mt-8 h-full bg-white md:rounded-3xl rounded-2xl flex flex-col-reverse lg:flex-row items-center justify-between gap-24 lg:gap-0 md:p-12 p-8 max-w-350 mx-auto">
